...
__declspec(dllexport) EipUint8 *get_data_input() { return g_assembly_input_data; }
__declspec(dllexport) EipUint8 *get_data_output() { return g_assembly_output_data; }
...
EipStatus ApplicationInitialization(void) {
  ...
  CreateAssemblyObject(assembly_config_instance, g_assembly_config_data,
                       assembly_config_size);
	    CreateAssemblyObject(assembly_input_instance, g_assembly_input_data,
                         assembly_input_size);
  CreateAssemblyObject(assembly_output_instance, g_assembly_output_data,
